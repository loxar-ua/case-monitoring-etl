...
from src.scrapper.configs import CENZOR_CFG

class CenzorScrapper(BaseScrapper):

    def __init__(self, media_orm: Media, **kwargs):
        super().__init__(media_orm, **kwargs)

        self.elements_cfg = CENZOR_CFG
    ...
    def get_links(self, start_date: datetime, end_date: datetime) -> list[str] | None:
        ...
        links = get_links_from_sitemap(
            ...
            sub_sitemaps_pattern=r"https://assets\.censor\.net/sitemap/censor\.net/sitemap_uk_resonance_(202[0-9]|20[3-9]\d)(0[1-9]|1[0-2])\.xml",
